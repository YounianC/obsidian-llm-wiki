...
[官网](https://llmwiki.greenerai.top/) | [Discussions](https://github.com/green-dalii/obsidian-llm-wiki/discussions)
...
| **🛠️ 维护 Wiki** | `Cmd+P` → "维护 Wiki" — 健康扫描：重复页面、断链、孤立页面、空洞页面、缺失别名 |
...
- **📊 提取粒度**（v1.6.2）：精细/标准/粗略 控制 LLM 从源文件提取实体的深度。"标准"适合大多数场景。
